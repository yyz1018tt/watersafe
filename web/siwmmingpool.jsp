...
<%--    <form action="/Provider" method="get">--%>
<%--        <div style="margin-top: 0%; margin-right: 20px">--%>
...
<div class="container" style="margin-top: 5%">
    ...
    <form action="/Provider" method="get">
        ...
        <div class="row" style="margin-top: 2%">
            ...
            <%--            <div class="col-lg-2">--%>
            <input type="submit" value="Search" class="btn btn-success btn-sm" style="">
            <%--            </div>--%>
    </form>
    <form action="/Provider" method="get">
            ...
            <div class="col-sm-6 mb-4">
                <div class="card shadow p-3 mb-5 bg-white rounded">
                    <div class="card-body">
                        ...
                        <p><b>Location:</b></p >
                            ${provider.map}
                            <%--                            <p><a href=" ">${provider.address} ${provider.suburb} ${provider.postcode}</a ></p >--%>
